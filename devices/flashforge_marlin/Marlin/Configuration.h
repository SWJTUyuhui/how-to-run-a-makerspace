...
#define STRING_CONFIG_H_AUTHOR "(bloomlj Flashforge Witbox)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "JLForge"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,200*16/8,49.7}  // default steps per unit for swjtumaker jl flashforge reprap
